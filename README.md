...
## Indirizzi mail usati

I file puntano già alle caselle del dominio `realestatesmart.it`:

- `support@realestatesmart.it` — supporto utenti (FAQ, bug, feature request)
- `privacy@realestatesmart.it` — richieste GDPR / privacy

Configura queste due mailbox sul provider del dominio prima del deploy in produzione.
